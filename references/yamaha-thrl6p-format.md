...
*Note: The physical preset spreadsheet and the app/hardware engine match exactly on amp/cabinet slot selections. The only minor discrepancy was that the sheet swapped Boutique and Modern Crunch labels, whereas the engine and tables above use the app's internal designations.*
